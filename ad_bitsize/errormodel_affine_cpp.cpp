...
ErrorModel_Affine_CPP::ErrorModel_Affine_CPP(DAG *_dag , NodeSchedular *_node_sched  ):BitSizePass( _dag ),node_sched(_node_sched),affine_index(1),affine_error_analysis_done(false){}


void ErrorModel_Affine_CPP::do_affine_analysis()
{
...
void ErrorModel_Affine_CPP::do_affine_analysis_node(dag_index node_num)
{
...
string ErrorModel_Affine_CPP::get_abs_eterms( stringstream &ss , Edge *CEdge  , stringstream &eterm)
{
...
void ErrorModel_Affine_CPP::affine_const_node_exp( Node *CNode )
{
...
void ErrorModel_Affine_CPP::affine_assign_node( Node *CNode )
{
...
void ErrorModel_Affine_CPP::affine_add_node( Node *CNode )
{
...
void ErrorModel_Affine_CPP::affine_sub_node( Node *CNode )
{
  Edge *edge_l = c_dag->edge_vec[ CNode->in_edges[0] ];
  Edge *edge_r = c_dag->edge_vec[ CNode->in_edges[1] ];
  Edge *edge_out = c_dag->edge_vec[ CNode->out_edges.back() ];
...
void  ErrorModel_Affine_CPP::affine_div_node( Node *CNode ){
  Edge *edge_l = c_dag->edge_vec[ CNode->in_edges[0] ];
  Edge *edge_r = c_dag->edge_vec[ CNode->in_edges[1] ];
  Edge *edge_out = c_dag->edge_vec[ CNode->out_edges.back() ];
...
void ErrorModel_Affine_CPP::affine_mul_node( Node *CNode )
{
...
void ErrorModel_Affine_CPP::affine_shiftl_node( Node *CNode )
{
  Edge *edge_l = c_dag->edge_vec[ CNode->in_edges[0] ];
  Edge *edge_r = c_dag->edge_vec[ CNode->in_edges[1] ];
  Edge *edge_out = c_dag->edge_vec[ CNode->out_edges.back() ];
...
void ErrorModel_Affine_CPP::affine_shiftr_node( Node *CNode )
{
  Edge *edge_l = c_dag->edge_vec[ CNode->in_edges[0] ];
  Edge *edge_r = c_dag->edge_vec[ CNode->in_edges[1] ];
  Edge *edge_out = c_dag->edge_vec[ CNode->out_edges.back() ];
...
void ErrorModel_Affine_CPP::gen_signal_bwname( stringstream &ss, Edge* CEdge)
{
...
void ErrorModel_Affine_CPP::gen_signal_errorname( stringstream &ss, Edge* CEdge)
{
...
void ErrorModel_Affine_CPP::gen_signal_err_expr( stringstream &ss, Edge *CEdge )
{
...
void ErrorModel_Affine_CPP::affine_input_node( Node *CNode )
{
...
void ErrorModel_Affine_CPP::show_affine_vecs()
{
...
void ErrorModel_Affine_CPP::gen_matlab_err_func( ostream &os)
{
...
// 	{
// 	   temp_os << (*ename_itr).second << " = ";
	 
// 	   var_decs << (*ename_itr).second << ", ";
...
// 	  // temp_os <<  "2^-(" << dynamic_cast< HWfix *>(CEdge->my_var)->frac_bw  << rounding << ");" << endl;
	  
// 	  //temp_os << "2^-(bw_out(" << bw_out_ctr++ << "));" << endl;
// 	}
//        else{
// 	  temp_os << (*ename_itr).second << " = ";
